                ...
                <div class="w-11/12 mx-auto">
                    <div class="xl:w-full mx-auto xl:mx-0">
                        <div class="mt-5 flex flex-col xl:w-full lg:w-full w-full">
                            ...
                            <input aria-label="enter question" type="text" id="question" name="question" class="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-cyan-700 text-gray-800 bg-transparent dark:text-gray-100" maxlength="100" placeholder="Question" />
